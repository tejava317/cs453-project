...
exports.TerminationManager = void 0;
/**
...
class TerminationManager {
     ...
     */
    isTriggered() {
        return !this._terminationTriggers.every((trigger) => !trigger.isTriggered());
    }
    /**
    ...
    removeTrigger(trigger) {
        this._terminationTriggers.splice(this._terminationTriggers.indexOf(trigger), 1);
        return this;
    }
}
exports.TerminationManager = TerminationManager;
//# sourceMappingURL=TerminationManager.js.map