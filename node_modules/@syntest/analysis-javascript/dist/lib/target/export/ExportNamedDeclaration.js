...
exports.extractExportsFromExportNamedDeclaration = void 0;
function extractFromObjectPattern(visitor, filePath, path, initPath) {
    const exports = [];
    ...
    if (path.get("properties").length !== initPath.get("properties").length) {
        ...
        throw new Error("Number of properties in object pattern and object expression do not match");
    }
...
function extractFromArrayPattern(visitor, filePath, path, initPath) {
    const exports = [];
...
function extractExportsFromExportNamedDeclaration(visitor, filePath, path) {
    const exports = [];
        ...
        if (declaration.isFunctionDeclaration() ||
            ...
            for (const declaration_ of declaration.get("declarations")) {
                ...
                if (id.isIdentifier()) {
                    ...
                    exports.push(...extractFromObjectPattern(visitor, filePath, id, init));
                }
        ...
        for (const specifierPath of path.get("specifiers")) {
            if (specifierPath.isExportSpecifier()) {
                ...
                exports.push({
                    ...
                    renamedTo: specifierPath.node.exported.type === "Identifier"
...
exports.extractExportsFromExportNamedDeclaration = extractExportsFromExportNamedDeclaration;
