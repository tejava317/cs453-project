...
exports.TargetFactory = void 0;
const path = require("node:path");
const core_1 = require("@babel/core");
const Factory_1 = require("../Factory");
const ExportVisitor_1 = require("./export/ExportVisitor");
const TargetVisitor_1 = require("./TargetVisitor");
/**
 * TargetFactory for Javascript.
 *
 * @author Dimitri Stallenberg
 */
class TargetFactory extends Factory_1.Factory {
    /**
     ...
     */
    extract(filePath, AST) {
        // bit sad that we have to do this twice, but we need to know the exports
        const exportVisitor = new ExportVisitor_1.ExportVisitor(filePath, this.syntaxForgiving);
        (0, core_1.traverse)(AST, exportVisitor);
        const exports = exportVisitor.exports;
        const visitor = new TargetVisitor_1.TargetVisitor(filePath, this.syntaxForgiving, exports);
